...
L'Organisation peut désigner d'autres ***« Partenaires »***, en plus des Ratifieurs, pour aider dans sa gouvernance et ses opérations, à condition que ces Partenaires aient également accepté de se conformer à tous les termes de la présente Constitution. Dans ce cadre, l'Organisation peut définir la manière dont elle accorde ou retire le statut de Partenaire, sauf indication contraire des Ratifieurs et les Ratifieurs peuvent préciser qui sont les Partenaires au moment de l’adoption.

Chaque Partenaire peut s’appuyer sur les autorités accordées par la présente Constitution, dans la mesure où les Ratifieurs détenaient ces autorités avant son adoption. Toutes les responsabilités et contraintes d’un(e) Partenaire découlent de la présente Constitution et des résultats de ses processus, ainsi que de toute obligation légale du Partenaire envers l'Organisation lorsqu'il/elle agit au nom de cette dernière. Toute attente ou contrainte implicite n’a aucun poids sur un(e) Partenaire, de même que tout ordre émis en dehors de l’autorité accordée par la présente Constitution.
...
Un Rôle peut également contenir des ***« Politiques »***, qui sont des délégations ou des restrictions d'autorité, ou des règles particulières qui s'appliquent au sein de ce Rôle.
...
Le Cercle à l'intérieur d'un Rôle est considéré comme un ***« Sous-Cercle »*** du Cercle plus large qui contient le Rôle, tandis que ce Cercle plus large est son ***« Super-Cercle »***.
...
Lorsqu'un Rôle n'est attribué qu'à des personnes qui ne sont pas des Partenaires de l'Organisation, chaque Leader de Cercle est automatiquement considéré comme Leader de Rôle pour le Rôle en question. Toutefois, cette affectation par défaut ne s'applique que dans la mesure où les personnes non-Partenaires ne remplissent pas activement les responsabilités et les devoirs attendus d’un(e) Partenaire.
...
En tant que Partenaire, vous avez le devoir de faire preuve de transparence envers les Leaders de Rôle de l’Organisation, à leur demande, comme suit :
...
- **(d) Points de check-list :** vous devez vérifier la réalisation de toutes les actions récurrentes que vous effectuez pour vos Rôles, ou en tant que Partenaire de l'Organisation. Sur demande, vous devez continuer de partager ces réalisations régulièrement, jusqu'à ce que vous estimiez qu'elles ne sont plus utiles.
- **(e) Indicateurs :** vous devez partager tous les indicateurs que vous collectez dans vos Rôles ou en tant que Partenaire de l'Organisation. Sur demande, vous devez continuer de partager ces indicateurs régulièrement, jusqu'à ce que vous estimiez qu'ils ne sont plus utiles.
...
En tant que Partenaire, vous avez le devoir de traiter rapidement les messages et les demandes des Leaders de Rôle de l’Organisation, comme suit :
...
- **(b) Requête pour un Projet ou une Prochaine-Action :** les autres peuvent vous demander de prendre une Prochaine-Action ou un Projet spécifique. Vous devez l'accepter et en faire le suivi si vous pensez que cela a du sens pour l’un de vos Rôles ou en tant que Partenaire de l’Organisation, au moins en l’absence de priorités concurrentes. Si vous ne l’acceptez pas, vous devez soit expliquer votre raisonnement, soit proposer autre chose qui, selon vous, répondra au besoin du demandeur.
...
En tant que Partenaire, vous avez le devoir de prioriser votre attention en respectant les points suivants :
...
Tout(e) Partenaire peut demander au Secrétaire d'un Cercle de se prononcer sur la validité de toute Gouvernance au sein de ce Cercle ou de tout Sous-Cercle de celui-ci. Si le Secrétaire conclut que la Gouvernance en question enfreint les règles de la présente Constitution, il doit la rayer des registres du Cercle. Après l’avoir fait, le Secrétaire doit rapidement informer l’ensemble des Partenaires qui occupent un Rôle dans le Cercle, à la fois de ce qu'il a supprimé et des raisons pour lesquelles il l’a fait.

### 4.3 Initiative Individuelle

En tant que Partenaire, vous êtes autorisé(e) dans certains cas à prendre une ***« Initiative Individuelle »*** qui vous permet d’agir au-delà de l'autorité de vos Rôles ou même d’enfreindre les règles de la présente Constitution.
...
Si, à un moment donné, il apparaît clairement au Facilitateur qu'une Proposition ne répond pas à l’un de ces critères, le Facilitateur doit écarter la Proposition.
...
Une Rupture de Processus dans un Cercle n'est pas automatiquement considérée comme une Rupture de Processus dans son Super-Cercle. Cependant, s'il reste non résolu pendant un temps excessif, le Super-Cercle est également considéré comme étant en Rupture de Processus.
